...
# Step 4: Estimate and print the percentage of total amount to be recovered up to six months in the future
recovery_amounts = analyzer.estimate_recovery_percentage_six_months()

# Next, calculate and print the percentage of loans that have been a loss to the company
